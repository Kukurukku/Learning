...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UINavigationController *navi = [[UINavigationController alloc] initWithNavigationBarClass:[CustomNaviBar class] toolbarClass:nil];
    CGRect newFrame = navi.navigationBar.frame;
    newFrame.size.height = 56;
    navi.navigationBar.frame = newFrame;
    navi.viewControllers = @[self.rootViewController];
