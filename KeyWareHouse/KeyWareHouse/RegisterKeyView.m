...
@implementation RegisterKeyView
@synthesize ID;
-(void)viewDidLoad{
    ...
    if([ID isEqual:@""]){
        ...
        self.passWord.text = array[2];
        self.note.text = array[3];
...
- (void)updateKeyInfo{
    ...
    [array addObject:self.passWord.text];    // 鍵のパスワード
    [array addObject:self.note.text];    // 鍵の備考
